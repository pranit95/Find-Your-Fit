...
//     task_obj.forEach(function(item , index){
//         html += `<tr class ="row">
//         <td>${index + 1}</td>  
//         <td>${item.task_name}</td>
//         <td><button onclick = "delete_item(${index})">DELETE</button></td>
//         </tr>`
//     })
//     task_list.innerHTML = html;
// }
// function delete_item(index){
//     var exercise_info = JSON.parse((localStorage.getItem("localtask"));
//     exercise_info.splice(index , 1)
//     localStorage.setItem("localtask" , JSON.stringify(exercise_info));
//     show_task()
// }